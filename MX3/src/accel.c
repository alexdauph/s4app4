...
void ACL_Init()
{
    ...
    ACL_SetRegister(ACL_CTRL_REG1, 0x30); // Output data rate at 800Hz, no auto wake, no auto scale adjust, no fast read mode
    ACL_SetRegister(ACL_CTRL_REG1, 0x31); // Output data rate at 800Hz, no auto wake, no auto scale adjust, no fast read mode
}
