...
bool UDP_Commands_Init()
{
    ...
    memset(UDP_Buffer1, 0, sizeof(UDP_Buffer1));
    ...
    strcpy(UDP_Send_Buffer_Ptr, "123456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657585960123456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657585960");
    strcpy(UDP_Send_Buffer_Ptr + 222, "123456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657585960123456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657585960");
    strcpy(UDP_Send_Buffer_Ptr + 444, "123456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657585960123456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657585960");
    return true;
}
...
char UDP_Buffer1[MAX_PACKET_SIZE + 1];
char *UDP_Build_Buffer_Ptr;
char *UDP_Send_Buffer_Ptr;
...
int _UDP_Commands_SetOptions(SYS_CMD_DEVICE_NODE *pCmdIO, int argc, char **argv)
{
    ...
    strcpy(UDP_Send_Buffer_Ptr, argv[3]);
    return true;
}
